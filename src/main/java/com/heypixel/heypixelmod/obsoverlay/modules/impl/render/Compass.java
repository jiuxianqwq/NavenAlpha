...
public class Compass extends Module {
    ...
    public void onRender(EventRender e) {
        this.renderX = Mth.lerp(e.getRenderPartialTicks(), mc.player.xOld, mc.player.getX());
        this.renderZ = Mth.lerp(e.getRenderPartialTicks(), mc.player.zOld, mc.player.getZ());
