...
public class Stuck extends Module {
    ...
    public void onEnable() {
        this.stage = 0;
        this.packet = null;
        this.lastYaw = RotationManager.rotations.getYaw();
        this.lastPitch = RotationManager.rotations.getPitch();
                ...
                if (this.stage == 1) {
                    ...
                    if (this.shouldRotate() && (this.lastYaw != rotationYaw || this.lastPitch != rotationPitch)) {
                        ...
                        while (!this.packets.isEmpty()) {
                            NetworkUtils.sendPacketNoEvent(this.packets.poll());
                        }
    ...
    private boolean shouldRotate() {
        if (this.packet instanceof ServerboundUseItemPacket blockPlacement) {
            ...
            return this.packet instanceof ServerboundPlayerActionPacket playerDigging && playerDigging.getAction() == Action.RELEASE_USE_ITEM && mc.player.getUseItem().getItem() instanceof BowItem;
        }
    }
