...
//        if (e.getPacket() instanceof ClientboundPlayerInfoRemovePacket packet && e.getType() == EventType.RECEIVE && mc.getConnection() != null) {
//
...
//            }
//
//            if (this.timer.delay(this.delay.getCurrentValue()) && !this.messageQueue.isEmpty()) {
