...
public class Glow extends Module {
    ...
    public static boolean shouldGlow(Entity entity) {
        Glow module = Naven.getInstance().getModuleManager().getModule(Glow.class);
        if (!module.isEnabled()) {
            return false;
            ...
            return entity instanceof Animal && module.animals.getCurrentValue() || entity instanceof Arrow && module.arrows.getCurrentValue();
        }
    }
}
