    ...
    private Projectile.Path getPath(float partialTicks) {
        ...
        if (!stack.isEmpty() && this.isThrowable(item)) {
            ...
            if (RotationManager.isActive()) {
                ...
                yaw = Math.toRadians(Mth.lerp(partialTicks, RotationManager.lastAnimationRotation.getYaw(), RotationManager.animationRotation.getYaw()));
                pitch = Math.toRadians(Mth.lerp(partialTicks, RotationManager.lastAnimationRotation.getPitch(), RotationManager.animationRotation.getPitch()));
            } else {
        ...
        public boolean equals(Object o) {
            if (o == this) {
                ...
                if (Objects.equals(this$path, other$path)) {
                    Object this$result = this.result();
                    Object other$result = other.result();
