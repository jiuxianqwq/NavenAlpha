...
public class ValueBuilder {
    ...
    public ValueBuilder setDefaultX(float defaultX) {
        if (this.valueType == null) {
            this.setValueType(ValueType.DRAG);
        }

        if (this.valueType != ValueType.DRAG) {
    ...
    public ValueBuilder setDefaultY(float defaultY) {
        if (this.valueType == null) {
            this.setValueType(ValueType.DRAG);
        }
    ...
    public Value build() {
        if (this.valueType == null) {
            ...
            switch (this.valueType) {
                ...
                case DRAG:
                    return new DragValue(this.key, this.name, this.defaultX, this.defaultY, this.update, this.visibility);
                default:
